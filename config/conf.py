...
parser.add_argument('--wanet_test_data_dir', default=['data/wanet/poisoned_models_test/incept',
                    'data/wanet/clean_models_test/incept'], nargs='+', help='position of wanet test data')
parser.add_argument('--input_test_data_dir', default=['data/input/poisoned_models_test/incept',
                    'data/input/clean_models_test/incept'], nargs='+', help='position of input test data')
parser.add_argument('--bpp_test_data_dir', default=['data/bpp/poisoned_models_test/incept',
                    'data/bpp/clean_models_test/incept'], nargs='+', help='position of bpp test data')
...
parser.add_argument('--augment',default=False,action='store_true',help='whether use augmentation')
...
parser.add_argument('--gin_layer',default=2,type=int,help='number of the gin layer')
parser.add_argument('--aug_level',default=3,type=int,help='strength of augmentation')
parser.add_argument('--seed', default=0, type=int, help='experiment seed')
